-- ============================================================================
-- Corrección: Trigger prevent_tampering_reserved_purchases y Fusión Atómica en receive_purchase
-- ============================================================================

-- 1. Trigger defensivo de purchase_items: Solo validar si se reduce la cantidad pedida
...
begin
  ...
  -- Solo verificar capacidad si se reduce la cantidad comprometida con el proveedor
...
-- 2. Procedimiento receive_purchase con conversión previa y fusión de reservas físicas
