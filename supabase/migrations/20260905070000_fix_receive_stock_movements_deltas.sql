-- Migration: 20260905070000_fix_receive_stock_movements_deltas.sql
-- Fix: Asentar funciones definitivas de transition_order y receive_purchase
-- con Bloqueo Canónico Nivel 1 y deltas contables válidos en stock_movements.
