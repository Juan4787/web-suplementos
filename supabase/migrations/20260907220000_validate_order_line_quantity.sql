-- ============================================================================
-- MIGRACIÓN: Validación de cantidad en líneas y soporte para pedidos manuales
-- ============================================================================
-- 1. Rechaza con INVALID_ORDER si alguna línea contiene quantity <= 0 o nula.
-- 2. Si no se pasa protocolOrderId, asigna automáticamente source = 'manual' y
--    protocolChecksum = NULL, satisfaciendo la constraint 'orders_check2' tanto
--    para pedidos importados de WhatsApp como pedidos manuales directos.
