-- Migration: 20260905040000_fix_confirm_purchase_header_lock.sql
-- Corrección de Concurrencia: Bloqueo canónico de cabecera de compras (pu) y líneas (pi)
-- en confirm_imported_order para serializar atómicamente contra cancelaciones concurrentes.
...
begin
  ...
  loop
    ...
    -- Asignación Incoming: Bloqueo Canónico Nivel 2 (purchases pu) y Nivel 3 (purchase_items pi)
