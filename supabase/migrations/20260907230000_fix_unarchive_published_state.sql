-- ============================================================================
-- MIGRACIÓN: Restaurar published al desarchivar producto
-- ============================================================================
-- Al desarchivar un producto (p_archived = false), debe restaurar tanto active = true
-- como published = true, para que el producto vuelva a ser visible en la tienda pública
-- y seleccionable en nuevos pedidos manuales.
